...
def toss():
    ...
    if choice == 'batting' :
        print('HI BATSMAN')
        print('''   -----You have choosen to Bat 1st, 
        ...
        print('HI BOWLER')
        print('''   -----You have choosen to Ball 1st, 
          scroll up to see the rules and instructions----''')
        usr = 'I'
        pc = 'YOU'
        ball_code(usr, pc)
